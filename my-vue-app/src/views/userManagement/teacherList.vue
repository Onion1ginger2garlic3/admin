      ...
      <table class="list">
        ...
        <tbody>
          <tr v-for="teacher in teachers" :key="teacher.id">
            ...
            <td>
              <button class="editBtn" @click="editTeacher(teacher)">编辑</button>
              <button>日志</button>
              <button class="delet" @click="deleteTeacher(teacher)">删除</button>
              <button @click="resetPassword(teacher)">重置密码</button>
            </td>
          </tr>
        </tbody>
      </table>
        ...
        <form>
          ...
          <div class="edit" >
            <div class="item">
              ...
              <input id="number" v-model="FormData.number">
            </div>
            ...
            <button @click="saveTeacher" type="submit">提交</button>
          </div>
        </form>
    </div>
  </div>
  ...
  <div v-if="isDeleteVisible" class="modal">
      <div class="del-content">
        ...
        <div class="content-button">
          <button @click="saveTeacher" type="submit">确定</button>
...
const saveTeacher = () => {
  ...
  if (index !== -1) {
    // 更新对应老师的数据
    teachers.value[index] = { ...teachers.value[index], ...FormData };
  }
